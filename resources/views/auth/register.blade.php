            ...
            <div class="box">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input">
                        ...
                        @error('name') <span class="text-danger mt-3">{{ $messsage }}</span> @enderror
                    </div>
                    ...
                    <div class="input">
                        ...
                        @error('email') <span class="text-danger mt-3">{{ $messsage }}</span> @enderror
                    </div>
                    ...
                    <div class="input">
                        ...
                        @error('password') <span class="text-danger mt-3">{{ $messsage }}</span> @enderror
                    </div>
                    ...
                    <div class="input">
                        ...
                        @error('password_confirmation') <span class="text-danger mt-3">{{ $messsage }}</span> @enderror
                    </div>
